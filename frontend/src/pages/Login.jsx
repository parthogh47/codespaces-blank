    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F3F4F6] to-[#EFF6FF] flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-white rounded-3xl shadow-md border border-gray-100 p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-[#111827] mb-2">Welcome Back</h1>
          <p className="text-base text-[#4B5563]">Sign in to continue your learning journey</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-[#4B5563]">
          ...
          <Link to="/register" className="text-[#4F46E5] font-semibold hover:underline" data-testid="register-link">
            Sign up
          </Link>
        </p>
      </Card>
